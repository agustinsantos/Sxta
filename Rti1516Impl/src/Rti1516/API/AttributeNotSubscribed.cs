namespace Hla.Rti1516
{
    ...
    public sealed class AttributeNotSubscribed : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public AttributeNotSubscribed(string message) : base(message) { }
        ...
        public AttributeNotSubscribed(string message, Exception inner) : base(message, inner) { }
        ...
        private AttributeNotSubscribed(System.Runtime.Serialization.SerializationInfo info,
