namespace Hla.Rti1516
{
    ...
    public sealed class InteractionRelevanceAdvisorySwitchIsOn : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public InteractionRelevanceAdvisorySwitchIsOn(string message) : base(message) { }
        ...
        public InteractionRelevanceAdvisorySwitchIsOn(string message, Exception inner) : base(message, inner) { }
        ...
        /// </param>
        private InteractionRelevanceAdvisorySwitchIsOn(System.Runtime.Serialization.SerializationInfo info,
