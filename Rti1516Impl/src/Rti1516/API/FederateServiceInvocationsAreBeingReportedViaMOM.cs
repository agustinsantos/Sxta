namespace Hla.Rti1516
{
    ...
    public sealed class FederateServiceInvocationsAreBeingReportedViaMOM : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public FederateServiceInvocationsAreBeingReportedViaMOM(string message) : base(message) { }
        ...
        public FederateServiceInvocationsAreBeingReportedViaMOM(string message, Exception inner) : base(message, inner) { }
        ...
        private FederateServiceInvocationsAreBeingReportedViaMOM(
