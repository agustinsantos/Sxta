namespace Hla.Rti1516
{
    ...
    public sealed class CouldNotDiscover : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public CouldNotDiscover(string message) : base(message) { }
        ...
        public CouldNotDiscover(string message, Exception inner) : base(message, inner) { }
