namespace Hla.Rti1516
{
    ...
    public sealed class AttributeRelevanceAdvisorySwitchIsOn : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public AttributeRelevanceAdvisorySwitchIsOn(string message) : base(message) { }
        ...
        public AttributeRelevanceAdvisorySwitchIsOn(string message, Exception inner) : base(message, inner) { }
        ...
        private AttributeRelevanceAdvisorySwitchIsOn(System.Runtime.Serialization.SerializationInfo info,
