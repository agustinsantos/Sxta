namespace Hla.Rti1516
{
    ...
    public sealed class FederateNotExecutionMember : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public FederateNotExecutionMember(string message) : base(message) { }
        ...
        public FederateNotExecutionMember(string message, Exception inner) : base(message, inner) { }
        ...
        private FederateNotExecutionMember(System.Runtime.Serialization.SerializationInfo info,
