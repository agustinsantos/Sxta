namespace Hla.Rti1516
{
    ...
    public sealed class InteractionRelevanceAdvisorySwitchIsOff : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public InteractionRelevanceAdvisorySwitchIsOff(string message) : base(message) { }
        ...
        public InteractionRelevanceAdvisorySwitchIsOff(string message, Exception inner) : base(message, inner) { }
        ...
        private InteractionRelevanceAdvisorySwitchIsOff(System.Runtime.Serialization.SerializationInfo info,
