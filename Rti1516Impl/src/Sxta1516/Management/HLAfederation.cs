namespace Sxta.Rti1516.Management
{
    ...
    public class HLAfederation :   HLAobjectRoot, IHLAfederation 
    {
        ...
        private ILogicalTimeFactory LogicalTimeFactory_;

        public ILogicalTimeFactory LogicalTimeFactory
        {
            get { return LogicalTimeFactory_; }
            set { LogicalTimeFactory_ = value; }
        }

        private ILogicalTimeIntervalFactory LogicalTimeIntervalFactory_;

        public ILogicalTimeIntervalFactory LogicalTimeIntervalFactory
        {
            get { return LogicalTimeIntervalFactory_; }
            set { LogicalTimeIntervalFactory_ = value; }
        }
        // END TODO
