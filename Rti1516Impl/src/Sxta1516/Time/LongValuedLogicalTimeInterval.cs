namespace Sxta.Rti1516.Time
{
    ...
    /// </author>
    [Serializable]
    public class LongValuedLogicalTimeInterval : ILogicalTimeInterval
    {
        /// <summary> 
        ...
        {
            long otherValue = ((LongValuedLogicalTimeInterval)other).val;
        ...
        public override bool Equals(System.Object other)
        {
            try
            {
                return (val == ((LongValuedLogicalTimeInterval)other).val);
            }
