namespace Hla.Rti1516
{
    ...
    public sealed class AttributeNotRecognized : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public AttributeNotRecognized(string message) : base(message) { }
        ...
        public AttributeNotRecognized(string message, Exception inner) : base(message, inner) { }
        ...
        private AttributeNotRecognized(System.Runtime.Serialization.SerializationInfo info,
