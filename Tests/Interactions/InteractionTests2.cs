namespace Sxta.Rti1516.Tests.Interactions
{
    ...
    /// <summary>
    /// Some simple Intereaction Tests with a limited packet size.
    /// A limited packet size is frecuent in UDP transmissions and the
    /// protocol must fragment the message. 
    /// </summary>
    [TestFixture]
    public class InteractionTests2
    {
        ...
        private MyTestBootstrapObjectListener2 myListener;
        ...
        public void Init()
        {
            ...
            channelManager.StartNewConnection(new Uri("memory:1?PACKET_SIZE=60"));
            ...
            myListener = new MyTestBootstrapObjectListener2();
    ...
    public class MyTestBootstrapObjectListener2 : IBootstrapObjectModelInteractionListener
    {
        private static readonly ILog log = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        public MyTestBootstrapObjectListener2()
        {
        }
