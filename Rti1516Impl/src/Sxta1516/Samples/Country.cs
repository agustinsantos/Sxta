namespace Sxta.Rti1516.Samples
{
    ...
    ///</summary>
    /// <author> </author>
    [HLAObjectClassAttribute(Name = "Country",
    ...
    public class Country : HLAobjectRoot
    {
        ...
        public static Country NewCountry()
        {
            ...
            return (Country)NewInstance(myCallType);
        }
        ...
        public override string ToString()
        {
            return "Country(" + base.ToString()+ ", Name:" + Name + ", Population:" + Population + ", Position:" + Position + ")";
        }
    }
}
