namespace Hla.Rti1516
{
    ...
    public sealed class InvalidOrderType : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public InvalidOrderType(string message) : base(message) { }
        ...
        public InvalidOrderType(string message, Exception inner) : base(message, inner) { }
