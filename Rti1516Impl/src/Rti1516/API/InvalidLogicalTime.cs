namespace Hla.Rti1516
{
    ...
    public sealed class InvalidLogicalTime : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public InvalidLogicalTime(string message) : base(message) { }
        ...
        public InvalidLogicalTime(string message, Exception inner) : base(message, inner) { }
