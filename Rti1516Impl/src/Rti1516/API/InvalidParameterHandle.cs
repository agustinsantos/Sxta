namespace Hla.Rti1516
{
    ...
    public sealed class InvalidParameterHandle : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public InvalidParameterHandle(string message) : base(message) { }
        ...
        public InvalidParameterHandle(string message, Exception inner) : base(message, inner) { }
        ...
        private InvalidParameterHandle(System.Runtime.Serialization.SerializationInfo info,
