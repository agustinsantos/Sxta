...
namespace Hla.Rti1516
{
    ...
    public sealed class AttributeAcquisitionWasNotCanceled : RTIexception
    {
        /// <summary> 
        ...
        /// </param>
        public AttributeAcquisitionWasNotCanceled(string message) : base(message) { }
        ...
        public AttributeAcquisitionWasNotCanceled(string message, Exception inner) : base(message, inner) { }
        ...
        /// </param>
        private AttributeAcquisitionWasNotCanceled(System.Runtime.Serialization.SerializationInfo info,
